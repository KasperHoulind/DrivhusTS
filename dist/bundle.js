...
var UrlAlaram = "https://drivhus13.azurewebsites.net/api/AlarmData/";
var UrlDrivhus = "https://drivhus13.azurewebsites.net/api/drivhusdata/";
var table = document.getElementById("drivtable");
var inputID = document.createElement("input");
var inputTemp = document.createElement("input");
var inputHumi = document.createElement("input");
...
axios.get(UrlDrivhus)
    ...
    response.data.forEach(function (drivhus) {
        var row = document.createElement("tr");
        table.appendChild(row);
        //let drivhus_id = document.createElement("td");
        var drivhus_temp = document.createElement("td");
        var drivhus_humi = document.createElement("td");
